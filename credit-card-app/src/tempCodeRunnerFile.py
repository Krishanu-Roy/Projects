...
def run_credit_card_app():
    ...
    ttk.Button(card, text="Apply", command=on_submit, style="Accent.TButton").place(x=145, y=470, width=120, height=38)
    ttk.Button(card, text="Logout", command=lambda: logout_user(), style="Accent.TButton").place(x=145, y=430, width=120, height=38)
